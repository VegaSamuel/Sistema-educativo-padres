...
#!perl
#line 29
    eval 'exec E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\perl\bin\perl.exe';
