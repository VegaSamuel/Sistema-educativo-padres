...
if ('E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
