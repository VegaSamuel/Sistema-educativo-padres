...
FOR %%x IN ("E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\php\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\php\php.exe"
GOTO :INSTALLED
