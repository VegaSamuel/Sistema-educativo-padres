...
if "%PHPBIN%" == "" set PHPBIN=E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "E:\Android Git\sistema_educativo_padres\Sistema-educativo-padres\xamppMoodle\php\phpunit" %*
